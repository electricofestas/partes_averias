    ...
    .forEach((tarea) => {
      ...
      tareaElement.innerHTML = `
            ...
            <p class="mb-1">
                ...
                <strong>Horario:</strong> ${tarea.horaInicio} - ${
        tarea.horaFin
      }<br>
            ...
            ${tarea.fotos
              .map(
                (foto) =>
                  `<img src="${foto}" class="img-thumbnail" style="max-width: 100px;">`
              )
              .join("")}
            <button class="btn btn-danger btn-sm mt-2" onclick="eliminarTarea(${
              tarea.id
            })">Eliminar</button>
        `;
